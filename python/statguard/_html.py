...
def to_html(report) -> str:
    ...
    Args:
        report: A statguard.ValidationReport object.
...
<p style="margin-top:32px;color:#9ca3af;font-size:.8rem">
  Generated by <strong>StatGuard</strong> · <a href="https://github.com/Mullassery/statguard" style="color:#6b7280">github.com/Mullassery/statguard</a>
</p>
</body>
</html>"""
